      ...
      <div className="flex justify-between items-center bg-surface-container-lowest p-5 rounded-2xl border border-outline-variant/20 shadow-xs">
        ...
        {files.length > 0 && (
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onSubmit}
              className="px-5 py-2 text-xs font-extrabold uppercase tracking-widest bg-primary text-on-primary hover:bg-primary/95 rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 cursor-pointer transform hover:-translate-y-px"
            >
            ...
            {recentDocuments.map((doc) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center justify-between p-3.5 rounded-xl border border-outline-variant/10 hover:bg-surface-container-low hover:border-primary/30 transition-all cursor-pointer group shadow-2xs hover:shadow-xs transform hover:-translate-y-px"
                >
