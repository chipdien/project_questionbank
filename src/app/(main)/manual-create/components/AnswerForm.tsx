    ...
    <div className="flex flex-col gap-6 min-h-[180px]">
      ...
      {isTransitioning ? (
        <div className="flex flex-col items-center justify-center py-12 gap-3 text-on-surface-variant">
          ...
          <span className="text-xs font-semibold text-outline animate-pulse">Đang tải cấu hình đáp án...</span>
        </div>
      ) : (
        <>
          ...
          <div className={`flex flex-col gap-3 w-full ${questionType === 'ESSAY' ? '' : 'mt-6 border-t border-outline-variant/20 pt-6'}`}>
