  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] flex flex-col items-center justify-center px-4">
      <div className="text-center space-y-6 max-w-md">
        ...
        <h2 className="text-3xl font-bold text-[var(--color-on-surface)]">Không Có Quyền Truy Cập (403)</h2>
        ...
        <Link 
          href="/" 
          className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary hover:bg-[var(--color-primary-container)] text-[var(--color-on-primary)] font-medium rounded-[var(--radius-lg)] shadow-md transition-all mt-4"
        >
          Quay lại Trang Chủ
        </Link>
      </div>
